...
class Population {
  public target: any;
  public mutationRate: any;
  public generations: number;
  public perfectScore: number;
  public finished: boolean;
  public matingPool: any[];
  public best: string;
  public population: any[];
  constructor(t: any, m: any, populationSize: any, language: number) {
    this.target = t;
    this.mutationRate = m;
    this.generations = 0;
    this.perfectScore = 1;
    ...
    this.population = this.population.map(() => new DNA(this.target.length, language));
